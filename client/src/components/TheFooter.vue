...
import FooterCopyright from "@/components/footerComponents/FooterCopyright.vue";
...
$fontColor: map-get($colors, grayishBlue);
$lineColor: map-get($colors, abdelKerimsBeards);
$lineStyle: 1px solid $lineColor;
